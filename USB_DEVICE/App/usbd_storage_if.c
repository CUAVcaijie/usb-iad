...
#include <stdio.h>
extern void sd_write(uint8_t chan, uint8_t *buff, uint32_t sector, uint32_t count);
extern void sd_read(uint8_t chan, uint8_t *buff, uint32_t sector, uint32_t count);
